...
angular.module('webrtcTestApp')
  .service('$midiService', function ($streamService) {
    ...
    function MidiFile(data) { // octaveRangeInclude --> no se utiliza lo quito
      ...
      var stream = new $streamService.Stream(data);
      var headerChunk = readChunk(stream);
      if (headerChunk.id !== 'MThd' || headerChunk.length !== 6) {
        throw 'Bad .mid file - header not found';
      }
      var headerStream = new $streamService.Stream(headerChunk.data);
      ...
      for (var i = 0; i < header.trackCount; i++) {
        ...
        var trackStream = new $streamService.Stream(trackChunk.data);
